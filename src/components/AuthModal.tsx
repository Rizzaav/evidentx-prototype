...
export function AuthModal({
  ...
  const { signInWithEmail, signUpWithEmail, signInWithGitHubUsername, signInWithGoogleCredentials } = useAuth();
  ...
  const handleConnectGoogle = async (e: React.FormEvent) => {
    ...
    if (res.error) {
      ...
      setSuccessMessage('Google connected! Logging in...');
      setTimeout(() => onClose(), 700);
    }
  };
        ...
        <div className="px-6 pb-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-ink-200 bg-white py-2 text-xs font-semibold text-ink-700 hover:bg-ink-50 transition shadow-2xs"
            >
